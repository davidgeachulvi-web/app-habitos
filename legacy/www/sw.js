const AWAKE_SW = 'awake-shell-v149';
const AWAKE_SHELL = [
    './index.html',
    './app.css',
    './app.js',
    ...
    './js/chat.js',
    './js/habits.js',
    './js/badge-seal-art.js',
    './js/badge-coin-3d.js',
    './js/three.module.min.js',
    './js/OrbitControls.js',
    './js/SVGLoader.js',
    './js/RoomEnvironment.js',
    './js/coin-studio.js',
    './js/coin/coin-engine.js',
    './js/coin/coin-geometry.js',
    './js/coin/coin-materials.js',
    './js/coin/coin-reliefs.js',
    './js/coin/coin-scene.js',
    './js/coin/coin-presets.json'
];
...
function esRecursoShell(url) {
    if (/\/js\/coin\/coin-presets\.json$/.test(url.pathname)) return true;
    return /\/(index\.html|app\.css|app\.js|js\/(?:icons|chat|habits|badge-seal-art|badge-coin-3d|three\.module\.min|OrbitControls|SVGLoader|RoomEnvironment|coin-studio|coin\/coin-(?:engine|geometry|materials|reliefs|scene))\.js)$/.test(url.pathname);
}
